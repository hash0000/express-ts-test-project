...
router.post('/actor', jwt_middleware_1.AuthMiddleware, (0, validationHandler_middleware_1.ValidationMiddleware)(insert_schema_1.InsertActorSchema, 'body'), async function (req, res) {
    try {
...
router.get('/actors', jwt_middleware_1.AuthMiddleware, async function (_req, res) {
    try {
...
router.get('/actor/:id', jwt_middleware_1.AuthMiddleware, (0, validationHandler_middleware_1.ValidationMiddleware)(idSchema_validator_1.IdSchema, 'params'), async function (req, res) {
    try {
...
router.patch('/actor/:id', jwt_middleware_1.AuthMiddleware, (0, validationHandler_middleware_1.ValidationMiddleware)(idSchema_validator_1.IdSchema, 'params'), (0, validationHandler_middleware_1.ValidationMiddleware)(update_schema_1.UpdateActorSchema, 'body'), async function (req, res) {
    try {
...
router.delete('/actor/:id', jwt_middleware_1.AuthMiddleware, (0, validationHandler_middleware_1.ValidationMiddleware)(idSchema_validator_1.IdSchema, 'params'), async function (req, res) {
    try {
